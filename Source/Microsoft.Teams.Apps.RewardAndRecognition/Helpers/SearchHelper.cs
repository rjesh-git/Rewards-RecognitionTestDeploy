...
namespace Microsoft.Teams.Apps.RewardAndRecognition.Helpers
{
    ...
    public static class SearchHelper
    {
            ...
            IStringLocalizer<Strings> localizer)
        {
            ...
            searchServiceResults = await searchService?.SearchNominationDetailsAsync(query, teamId, count, skip);
                                ...
                                Columns = new List<AdaptiveColumn>
                                {
                                    ...
                                    new AdaptiveColumn
                                    {
                                        ...
                                        Items = new List<AdaptiveElement>
                                        {
                                            new AdaptiveImage
                                            {
                                                Url = string.IsNullOrEmpty(nominatedDetail.AwardImageLink) ? default : new Uri(nominatedDetail.AwardImageLink),
