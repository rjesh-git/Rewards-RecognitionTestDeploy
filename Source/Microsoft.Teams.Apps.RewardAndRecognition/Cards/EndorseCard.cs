...
namespace Microsoft.Teams.Apps.RewardAndRecognition.Cards
{
    ...
    public static class EndorseCard
    {
        ...
        public static Attachment GetEndorseCard(IStringLocalizer<Strings> localizer, TaskModuleResponseDetails nominatedDetails)
        {
                        ...
                        Columns = new List<AdaptiveColumn>
                        {
                            ...
                            new AdaptiveColumn
                            {
                                ...
                                Items = new List<AdaptiveElement>
                                {
                                    new AdaptiveImage
                                    {
                                        Url = string.IsNullOrEmpty(nominatedDetails.AwardLink) ? default : new Uri(nominatedDetails.AwardLink),
